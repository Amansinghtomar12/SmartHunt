...
function collectOptions() {
  return {
    ...
    exhaustive: $('#optExhaustive').checked,
    auth_cookies: $('#authCookie').value,
    auth_bearer: $('#authBearer').value,
    auth_headers: $('#authHeaders').value,
    auth_check_url: $('#authCheckUrl').value,
    auth_check_marker: $('#authCheckText').value,
    victim_cookies: $('#victimCookie').value,
    victim_bearer: $('#victimBearer').value,
    victim_headers: $('#victimHeaders').value,
